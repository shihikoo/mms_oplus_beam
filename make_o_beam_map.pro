...
; later part of point map code are run for mlt/ilat
                       ...
                       filename =  path_ev+'events_' + ts_date+'_to_'+ te_date+'_' + PLOT_AXIS(0)+'_vs_'+PLOT_AXIS(1) +'.ps'
                       title =  sort_title+'         '+PHASE + '       O!U+!N  BEAM  EVENS    ' +'!Cfrom  ' +ts_date+'  to  ' +te_date
                       xtitle = PLOT_AXIS(0) 
                       ytitle = PLOT_AXIS(1)
                       xrange = [-r_range,r_range]
                       yrange = [-r_range,r_range]
