...
PRO sort_o_beam_map_mms_multi, ps_plot = ps_plot, read_from_dat = read_from_dat, store_tplot = store_tplot, time_start = time_start, time_end = time_end, stop = stop $
...
;-----------------------------------------------------
  ...
  limitation_str = '' 
;   if keyword_set(avoid_compression_time)  then  limitation_str = '_avoid_compression'
  ...
  plot_path = output_path + 'plots' + limitation_str
  tplot_path = output_path + 'tplot_map' + limitation_str
...
;---------------------------------------------------------------------------
  res = read_daily_data_multi(time_start, time_end, tplot_path, data_path, read_from_dat = read_from_dat, store_tplot=store_tplot, avoid_2019 = avoid_2019, only_no_compress = only_no_compress)
