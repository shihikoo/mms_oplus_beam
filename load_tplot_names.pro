FUNCTION load_tplot_names, sc_str, bmodel, parallel_pa_range,  antiparallel_pa_range 
  ...
  all_tplot_names = { $
                    ...
                    diffflux_h1_pa_name:'mms'+sc_str+'_hpca_hplus_eflux_pa_00001_50000_nflux',$
...
;                    antiparallel_epcut_beam_denergy_readin_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut_beam_denergy_readin',$
                   ...
                   antiparallel_erange_beam_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_erange_beam' , $
                    ...
                    , antiparallel_dispersion_inverse_v_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity' $ 
                    ...
                    , antiparallel_dispersion_inverse_v_fitting_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity_fitting' $
                    ...
                    , antiparallel_dispersion_inverse_v_fitting_chisq_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity_fitting_chisq' $
                    ...
                    , antiparallel_dispersion_inverse_v_fitting_status_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity_fitting_status' $
                    ...
                    , antiparallel_dispersion_inverse_v_fitting_dof_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity_fitting_dof' $
                    ...
                    , antiparallel_dispersion_inverse_v_fitting_sigma_name: 'mms' + sc_str + '_hpca_oplus_eflux_pa_red_' + antiparallel_pa_low_str + '_' + antiparallel_pa_high_str +'_nflux_epcut' +'_dispersoin_1_of_velocity_fitting_sigma' $
